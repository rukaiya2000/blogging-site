...
const SignIn = () => {
    ...
    return (
        <div className="py-24">
            <div className="flex flex-col lg:flex-row rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm md:max-w-2xl lg:max-w-4xl">
                <div className="m-auto bg-cover flex items-center justify-center">
                    <Image width={500} height={500} src="/logo.png" alt="logo" className='w-1/2 lg:w-2/3 object-cover' onClick={() => router.push(ROUTES.DASHBOARD)} />
                </div>
