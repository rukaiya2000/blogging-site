...
const Preview = ({ params }: {
    ...
    return (
        <div className="w-full md:m-2 flex flex-col items-center justify-center tracking-wider leading-loose no-scrollbar p-2 md:px-10 lg:p-0">
            ...
            </div>
            {
                blog && blog.draft ? (
                    <div className="w-full lg:w-2/3 flex flex-col-reverse md:flex-row items-center justify-between mt-10">
                        <button className="w-2/3 md:w-fit border-2 px-16 py-2 rounded-lg border-tertiary bg-tertiary outline-none bg-opacity-30 hover:bg-opacity-100 my-2" onClick={handleReject}>Reject</button>
                        <button className="w-2/3 md:w-fit border-2 px-16 py-2 rounded-lg bg-secondary outline-none bg-opacity-30 hover:bg-opacity-100 my-2" onClick={() => router.push(`/publish/${params.id}`)}>Edit</button>
                        <button className="w-2/3 md:w-fit border-2 px-16 py-2 rounded-lg border-green-200 bg-secondary outline-none bg-opacity-30 hover:bg-opacity-100 my-2" onClick={handlePublish}>Publish</button>
                    </div>
                ) : (<div></div>)
            }
        </div>
